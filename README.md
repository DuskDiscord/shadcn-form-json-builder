# Shadcn Form JSON Builder

shadcn-form-json-builder is a React library that allows you to generate dynamic forms based on a JSON file. It uses react-hook-form for form management, supports customizable components for each field, and integrates with ShadCN UI for advanced form customization.
...
```bash
npm install shadcn-form-json-builder
```
...
import AutoForm from "shadcn-form-json-builder";
